...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Fermer dropdowns en cliquant ailleurs sans interférer avec Bootstrap
    document.addEventListener('click', function(e) {
        // Laisser Bootstrap gérer tous les dropdowns standards (y compris dans .btn-group)
        if (e.target.closest('.dropdown') || e.target.closest('.btn-group')) {
            return;
        }
        // Ne fermer que nos menus custom (profil/notification) ouverts manuellement
        document.querySelectorAll('.profile-dropdown.show, .notification-dropdown.show').forEach(menu => {
            menu.classList.remove('show');
        });
    });
