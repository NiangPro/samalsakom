...
try {
    ...
    $solde_disponible = $solde_data['total_cotise'] + $solde_data['total_bonus'] - $solde_data['total_retire'];
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-8">
                                ...
                                <div class="row text-white-50">
                                    ...
                                    <div class="col-4">
                                        <small>Bonus</small>
                                        <div class="fw-semibold"><?= number_format($solde_data['total_bonus'], 0, ',', ' ') ?></div>
                                    </div>
                                    <div class="col-4">
                                        <small>Retiré</small>
...
function demanderRetrait() {
    showToast('Fonctionnalité de retrait bientôt disponible', 'info');
}

function rechargerPortefeuille() {
    showToast('Fonctionnalité de rechargement bientôt disponible', 'info');
}
</script>
